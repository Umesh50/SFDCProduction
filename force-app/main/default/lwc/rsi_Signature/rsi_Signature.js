...
import saveSign from '@salesforce/apex/RSI_SignatureHelper.saveSign';
...
export default class Rsi_Signature extends LightningElement {
    @api recordId;
        ...
        saveSign({strSignElement: dataURL, recId : this.recordId})
            .then(result => {
                ...
                this.dispatchEvent(
                    new ShowToastEvent({
                        title: 'Success',
                        message: 'Thank you. We have captured your signature',
                        variant: 'success',
                    }),
                );
            ...
            .catch(error => {
                ...
                this.dispatchEvent(
                    new ShowToastEvent({
                        title: 'Unable to capture your signature. Please try again later',
